...
class QByteArray___ extends QByteArray {
		...
		private static final com.trolltech.qt.QNativePointer toNativePointer(byte[] data){
			if(data==null){
				return null;
			}
			com.trolltech.qt.QNativePointer pointer = new com.trolltech.qt.QNativePointer(com.trolltech.qt.QNativePointer.Type.Byte, data.length);
