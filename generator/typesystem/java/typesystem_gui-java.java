...
class QPixmapCache___ extends QPixmapCache {
		...
		public static QPixmap find(com.trolltech.qt.gui.QPixmapCache.Key key) {
			QPixmap pixmap = new QPixmap();
			if(find(key, pixmap.nativePointer())){
				return pixmap;
			}else{
...
class QGraphicsScene___ extends QGraphicsScene {
         ...
         */
        public final QGraphicsLineItem addLine(com.trolltech.qt.core.QLineF line) {
         ...
         * @return The resulting item.
         */
        public final QGraphicsLineItem addLine(com.trolltech.qt.core.QLineF line, QPen pen) {
