/****************************************************************************
**
** in parts Copyright (C) 2013 Peter Droste, Omix Visualization GmbH & Co. KG. All rights reserved.
**
...
QString ContainerTypeEntry::javaPackage() const {
    ...
    if (m_type == QQmlListPropertyContainer)
        return "com.trolltech.qt.qml";
    if (m_type == QDeclarativeListPropertyContainer)
        return "com.trolltech.qt.declarative";  // new for QDeclarative module but not yet implemented
    return "java.util";
}
