...
void CppImplGenerator::writeQtToJavaContainer(QTextStream &s,
    ...
    if (type->type() == ContainerTypeEntry::ListContainer
        ...
        s << endl
          << INDENT << "QQmlListProperty<";
        writeTypeInfo(s, arg, NoOption);
        s << "> * propertyPointer = new QQmlListProperty<";
        writeTypeInfo(s, arg, NoOption);
        s << ">(" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "__qt_return_value.object," << endl;
                s << INDENT << "__qt_return_value.data," << endl;
                s << INDENT << "__qt_return_value.append," << endl;
                s << INDENT << "__qt_return_value.count," << endl;
                s << INDENT << "__qt_return_value.at," << endl;
                s << INDENT << "__qt_return_value.clear" << endl;
            }
            s << INDENT << ");" << endl;
        }

        // generate a struct that contains the append, count, at, and clear function as well as a deleter function:
        s << INDENT << "struct Functions{" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "static void append(QQmlListProperty<void> * propertyList, void* newEntry){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QQmlListProperty<";
                writeTypeInfo(s, arg, NoOption);
                s << ">* list = static_cast<QQmlListProperty<";
                writeTypeInfo(s, arg, NoOption);
                s << ">*>(propertyList->data);" << endl;
                s << INDENT << "list->append(list, static_cast<";
                writeTypeInfo(s, arg, NoOption);
                s << "*>(newEntry));" << endl;
            }
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static int count(QQmlListProperty<void> * propertyList){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QQmlListProperty<";
                writeTypeInfo(s, arg, NoOption);
                ...
                writeTypeInfo(s, arg, NoOption);
                s << ">*>(propertyList->data);" << endl;
                s << INDENT << "return list->count(list);" << endl;
            }
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static void* at(QQmlListProperty<void> * propertyList, int index){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QQmlListProperty<";
                writeTypeInfo(s, arg, NoOption);
                ...
                writeTypeInfo(s, arg, NoOption);
                s << ">*>(propertyList->data);" << endl;
                s << INDENT << "return list->at(list, index);" << endl;
            }
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static void clear(QQmlListProperty<void> * propertyList){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QQmlListProperty<";
                writeTypeInfo(s, arg, NoOption);
                ...
                writeTypeInfo(s, arg, NoOption);
                s << ">*>(propertyList->data);" << endl;
                s << INDENT << "list->clear(list);" << endl;
            }
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static void deleteListProperty(void* data){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QQmlListProperty<";
                writeTypeInfo(s, arg, NoOption);
                ...
                writeTypeInfo(s, arg, NoOption);
                s << ">*>(data);" << endl;
                s << INDENT << "delete list;" << endl;
            }
            s << INDENT << "}" << endl << endl;
        }
        s << INDENT << "};" << endl;

        s << INDENT << "QtjambiQmlListProperty::AppendFunction appendFunction = 0;" << endl;
        s << INDENT << "QtjambiQmlListProperty::CountFunction countFunction = 0;" << endl;
        s << INDENT << "QtjambiQmlListProperty::AtFunction atFunction = 0;" << endl;
        s << INDENT << "QtjambiQmlListProperty::ClearFunction clearFunction = 0;" << endl;
        s << INDENT << "if(__qt_return_value.append){" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "appendFunction = &Functions::append;" << endl;
        }
        s << INDENT << "}" << endl;

        s << INDENT << "if(__qt_return_value.count){" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "countFunction = &Functions::count;" << endl;
        }
        s << INDENT << "}" << endl;

        s << INDENT << "if(__qt_return_value.at){" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "atFunction = &Functions::at;" << endl;
        }
        s << INDENT << "}" << endl;

        s << INDENT << "if(__qt_return_value.clear){" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "clearFunction = &Functions::clear;" << endl;
        }
        s << INDENT << "}" << endl;
        s << INDENT << endl;
        s << INDENT << "QtjambiQmlListProperty * property = new QtjambiQmlListProperty(" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "__qt_return_value.object," << endl;
                s << INDENT << "propertyPointer," << endl;
                s << INDENT << "appendFunction," << endl;
                s << INDENT << "countFunction," << endl;
                s << INDENT << "atFunction," << endl;
                s << INDENT << "clearFunction" << endl;
            }
            s << INDENT << ");" << endl;
        }
        s << INDENT << "property->m_deleter = &Functions::deleteListProperty;" << endl;
        s << INDENT << "jobject __java_return_value = qtjambi_from_object(__jni_env, property, \"";
        s << arg->typeEntry()->targetLangName() << "\", \"" << arg->typeEntry()->javaPackage().replace(".", "/") + "\", true);" << endl;
        s << INDENT << "" << endl;
        ...
        AbstractMetaType *arg = java_type->instantiations().at(0);
        s << endl
          << INDENT << "QDeclarativeListProperty<";
        writeTypeInfo(s, arg, NoOption);
        s << "> * propertyPointer = new QDeclarativeListProperty<";
        writeTypeInfo(s, arg, NoOption);
        s << ">(" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
        ...
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "static void append(QDeclarativeListProperty<void> * propertyList, void* newEntry){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QDeclarativeListProperty<";
                writeTypeInfo(s, arg, NoOption);
                s << ">* list = static_cast<QDeclarativeListProperty<";
                writeTypeInfo(s, arg, NoOption);
                s << ">*>(propertyList->data);" << endl;
                s << INDENT << "list->append(list, static_cast<";
                writeTypeInfo(s, arg, NoOption);
            ...
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static int count(QDeclarativeListProperty<void> * propertyList){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QDeclarativeListProperty<";
                writeTypeInfo(s, arg, NoOption);
            ...
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static void* at(QDeclarativeListProperty<void> * propertyList, int index){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QDeclarativeListProperty<";
                writeTypeInfo(s, arg, NoOption);
            ...
            s << INDENT << "}" << endl << endl;
            s << INDENT << "static void clear(QDeclarativeListProperty<void> * propertyList){" << endl;
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
                s << INDENT << "QDeclarativeListProperty<";
                writeTypeInfo(s, arg, NoOption);
        ...
        s << INDENT << "QtjambiDeclarativeListProperty::AppendFunction appendFunction = 0;" << endl;
        s << INDENT << "QtjambiDeclarativeListProperty::CountFunction countFunction = 0;" << endl;
        s << INDENT << "QtjambiDeclarativeListProperty::AtFunction atFunction = 0;" << endl;
        s << INDENT << "QtjambiDeclarativeListProperty::ClearFunction clearFunction = 0;" << endl;
        s << INDENT << "if(__qt_return_value.append){" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            s << INDENT << "appendFunction = &Functions::append;" << endl;
        ...
        s << INDENT << "}" << endl;
        s << INDENT << endl;
        s << INDENT << "QtjambiDeclarativeListProperty * property = new QtjambiDeclarativeListProperty(" << endl;
        {
            Indentation indent(INDENT);Q_UNUSED(indent)
            {
                Indentation indent2(INDENT);Q_UNUSED(indent2)
