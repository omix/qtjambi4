    ...
    */
    ...
    if (qtJambiDebugTools()) {
        ...
        if (destructorName.isEmpty())
            destructorName = "qtjambiGenericDestructor<" + entry->qualifiedCppName() + ", __name_" + QString(entry->name()).replace(":", "_").replace(' ', '_') + ">";
    }
...
#else
        << " )," << endl
        << "                            QtMetaTypePrivate::QMetaTypeFunctionHelper<void>::Destruct," << endl
        << "                            QtMetaTypePrivate::QMetaTypeFunctionHelper<void>::Construct," << endl
