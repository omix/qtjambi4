...
{
    QTJAMBI_DEBUG_TRACE("(native) entering: QtJambiLink::deleteNativeObject(JNIEnv *)");
#ifdef DEBUG_REFCOUNTING
    {
...
//                    qobj->metaObject()->className());
            ...
            QTJAMBI_DEBUG_TRACE("call delete QObject");
            delete qobj;
...
//                    qobj->metaObject()->className());
            m_delete_later = 1;
            QTJAMBI_DEBUG_TRACE("call QObject::deleteLater()");
            qobj->deleteLater();
...
//                qDebug() << ".. au ..";
    ...
    //             }
        ...
        if (m_ownership == JavaOwnership && deleteInMainThread() && (QCoreApplication::instance() == 0 || QCoreApplication::instance()->thread() != QThread::currentThread())) {
            ...
            if (QCoreApplication::instance()) {
                QTJAMBI_DEBUG_TRACE("use QtJambiDestructorEvent");
           ...
           QTJAMBI_DEBUG_TRACE("call QMetaType::destroy()");
           ...
           rv = 0x0004;    // used QMetaType::destroy
            ...
            QTJAMBI_DEBUG_TRACE("call destructor_function");
    ...
    QTJAMBI_DEBUG_TRACE("(native) leaving: QtJambiLink::deleteNativeObject(JNIEnv *)");
    return rv;
}
