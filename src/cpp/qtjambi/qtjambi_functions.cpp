...
void * constructHelper(const void *_pointer)
{
...
extern "C" Q_DECL_EXPORT void JNICALL
QTJAMBI_FUNCTION_PREFIX(Java_com_trolltech_qt_internal_MetaObjectTools_registerMetaType)
(JNIEnv *env, jclass, jclass clazz)
{
    ...
    if(qtName.contains("*")){
        int id = QMetaType::registerType(qtName.toLatin1().data(), reinterpret_cast<QMetaType::Destructor>(deleteHelper), reinterpret_cast<QMetaType::Constructor>(constructHelper));
