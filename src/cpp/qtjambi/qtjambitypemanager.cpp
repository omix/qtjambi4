...
//    if(clazz!=0){
//        jclass metaObjectTools = resolveClass(mEnvironment, "MetaObjectTools", "com/trolltech/qt/internal/");
...
//                }
//            }else{
//                qWarning() << "QtJambiTypeManager::resolveQFlags unable to find class " << "com/trolltech/qt/internal/MetaObjectTools";
//            }
//        }else{
//            qWarning() << "QtJambiTypeManager::resolveQFlags unable to find static method "
//                       << "com/trolltech/qt/internal/MetaObjectTools::resolveQFlagsActualTypeArgument(Ljava/lang/Class;)Ljava/lang/Class;";
//        }
//    }else{
//        return QLatin1String("JObjectWrapper");
//    }
