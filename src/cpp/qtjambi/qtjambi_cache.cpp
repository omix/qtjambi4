...
void StaticCache::resolveMetaData_internal()
{
    ...
    MetaData.propertyScriptablesArray = env->GetFieldID(MetaData.class_ref, "propertyScriptablesArray", "[Ljava/lang/reflect/Method;");
    Q_ASSERT(MetaData.propertyScriptablesArray);
