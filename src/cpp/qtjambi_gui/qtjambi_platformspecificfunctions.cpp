...
/*
 * Class:     com_trolltech_qt_gui_X11Functions
 * Method:    __qt_x11_wait_for_window_manager
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_X11Functions__1_1qt_1x11_1wait_1for_1window_1manager
#ifdef Q_OS_LINUX
...
/*
 * Class:     com_trolltech_qt_gui_MacOSXFunctions
 * Method:    __qt_mac_secure_keyboard
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_MacOSXFunctions__1_1qt_1mac_1secure_1keyboard
#ifdef Q_OS_MAC
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_MacOSXFunctions__1_1qt_1mac_1set_1dock_1menu
#ifdef Q_OS_MAC
  (JNIEnv *, jclass, jlong w0){
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_MacOSXFunctions__1_1qt_1mac_1set_1menubar_1icons
#ifdef Q_OS_MAC
  (JNIEnv *, jclass, jboolean enable){
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_MacOSXFunctions__1_1qt_1mac_1set_1menubar_1merge
#ifdef Q_OS_MAC
  (JNIEnv *, jclass, jboolean enable){
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_MacOSXFunctions__1_1qt_1mac_1set_1native_1menubar
#ifdef Q_OS_MAC
  (JNIEnv *, jclass, jboolean enable){
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_trolltech_qt_gui_MacOSXFunctions__1_1qt_1mac_1set_1press_1and_1hold_1context
#ifdef Q_OS_MAC
  (JNIEnv *, jclass, jboolean enable){
