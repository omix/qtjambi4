...
public class FilterQt3D extends AbstractFilter {
	...
	private static final Class<?> categoryMarkerClass = CategoryQt3D.class;
	private static final String packageName = "com.trolltech.qt.qt3d";
	...
	public FilterQt3D(boolean includeFlag) {
		super(includeFlag);
	}
