...
public class TestVirtualFunctionsQPlastiqueStyle extends QApplicationTest {
    ...
    public void run_cppCreatedObjects() throws Exception {
        ...
        assertEquals(15, java_plastique.pixelMetric(QStyle.PixelMetric.PM_SliderThickness));
        assertEquals(20, java_windowsstyle.pixelMetric(QStyle.PixelMetric.PM_SliderThickness));
