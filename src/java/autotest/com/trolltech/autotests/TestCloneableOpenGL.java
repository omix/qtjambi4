...
import com.trolltech.qt.opengl.QGLBuffer;
import com.trolltech.qt.opengl.QGLColormap;
import com.trolltech.qt.opengl.QGLFormat;
import com.trolltech.qt.opengl.QGLFramebufferObjectFormat;
import com.trolltech.qt.opengl.QGLFunctions;
...
public class TestCloneableOpenGL extends QApplicationTest {
	...
	@Test
	public void run_clone_QGLFunctions() {
		QGLFunctions org = new QGLFunctions();
		QGLFunctions clone = org.clone();
		org.dispose();
		QGLFunctions clone2 = clone.clone();
		assertEquals(clone, clone2);
	}
