...
**
****************************************************************************/
package com.trolltech.demos.qt3dquick.robobounce;
...
@QtJambiExample(name = "Qt3DQuick RoboBounce", canInstantiate = "call-static-method:checkQt3DQuickSupport")
public class Main extends QMainWindow{
	...
	private static QWidget createView(QMainWindow parent){
		...
		if(parent!=null){
			...
			parent.setWindowTitle("RoboBounce");
		    ...
		    view.setWindowTitle("RoboBounce");
		    view.setWindowIcon(new QIcon("classpath:/com/trolltech/demos/qt3dquick/quick3d.png"));
		}
	    view.setSource(new QUrl("classpath:/com/trolltech/demos/qt3dquick/robobounce/qml/robobounce.qml"));
