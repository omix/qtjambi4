...
public class Teapot extends MeshObject {
	...
	public Teapot(QObject parent){
		super(createTeapot(parent), parent);
	}
	
	private static QGLSceneNode createTeapot(QObject parent)
	{
	    QGLBuilder builder = new QGLBuilder();
	    QGLTeapot teapot = new QGLTeapot();
	    builder.addBezierPatches(teapot);
