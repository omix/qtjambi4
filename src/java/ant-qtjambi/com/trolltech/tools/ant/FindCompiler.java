...
public class FindCompiler {
            ...
            try {
                ...
                if(vcdir == null) {
                    ...
                    if(!fileVcDir.isDirectory()) {
                        ...
                        String redistDir;
                        if(compiler == Compiler.MSVC2005_64 || compiler == Compiler.MSVC2008_64 || compiler == Compiler.MSVC2010_64 || compiler == Compiler.MSVC2012_64)
    ...
    private Compiler testForGCC() {
        try {
            ...
            String[] sA = Exec.executeCaptureOutput(cmdAndArgs, new File("."), project, null, null, false);
